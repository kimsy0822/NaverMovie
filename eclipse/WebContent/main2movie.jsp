                    ...
                    <li class="item1">
                      <div class="obj_off">
                        <a href="moviedetail.do?mid=${mlist.mid }">
                          ...
                          <c:if test="${mlist.str_star != 10.00}">
                          ...
                          <c:set var="TextValue" value="${mlist.str_star}"/>
                            <span class="rank_star l"><span class="star_off"><em>별점 - 총 10점 중</em></span><span class="star_on" style="width:${mlist.str_star*10 }%"><em>${mlist.str_star } 점</em></span></span>
                            <strong class="l"><span class="char sc_num${fn:substring(TextValue,0,1) }"><em>${fn:substring(TextValue,0,1) }</em></span><span class="char sc_num${fn:substring(TextValue,1,2) }"><em>${fn:substring(TextValue,1,2) }</em></span><span class="char sc_dot"><em>.</em></span><span class="char sc_num${fn:substring(TextValue,3,4) }"><em>${fn:substring(TextValue,3,4) }</em></span><span class="char sc_num${fn:substring(TextValue,4,5) }"><em>${fn:substring(TextValue,4,5) }</em></span></strong>
                          </c:if>
                          </span>
