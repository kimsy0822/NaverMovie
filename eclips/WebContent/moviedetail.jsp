    ...
    <div class="content-wrap">
      ...
      <article id="moviedetail">
        ...
        <div class="mv_info_area" style="display: block;">
              ...
              <div class="score score_left">
                ...
                <div class="star_score ">
                  <a href="#" id="pointNetizenPersentBasic">
                  	<span class="st_off"><span class="st_on" style="width:${vo.star*10}%"></span></span>
                  	<c:if test="${vo.star != 10.00}">
                  	...
                  	<c:if test="${vo.star == 10.00}">
                  	<c:set var="TextValue" value="${vo.str_star}"/>
                  		<em class="num${fn:substring(TextValue,0,1) }">${fn:substring(TextValue,0,1) }</em><em class="num${fn:substring(TextValue,1,2) }">${fn:substring(TextValue,1,2) }</em><em class="dot">.</em><em class="num${fn:substring(TextValue,3,4) }">${fn:substring(TextValue,3,4) }</em><em class="num${fn:substring(TextValue,4,5) }">${fn:substring(TextValue,4,5) }</em>
                  	</c:if>	
                  </a>
                </div>
              </div>
          ...
          <!-- 포스터 -->
          <div class="poster">
            <a href="images/poster/${vo.mid }.jpg" target="_blank"><img src="images/poster/${vo.mid }.jpg" alt="${vo.mname }" width="203" height="290" onerror="this.src='images/dft_img203x290.png'"><span>포스터 크게보기</span></a>
          </div>
          <!-- //포스터 -->
        </div>
